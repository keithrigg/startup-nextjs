          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                {/* Navigation Menu - Always Dropdown */}
                <nav
                  id="navbarCollapse"
              ...
              <div className="flex items-center justify-end">
                ...
                <div className="flex items-center space-x-2 mr-20">
                  ...
                  <svg
                    viewBox="0 0 23 23"
                    className="w-5 h-5 stroke-current dark:text-white"
                    fill="none"
                  >
                    <path
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-primary transition-all duration-300">
                      <div
                        className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-all duration-300 ${
                          currentTheme === "light" ? "translate-x-5" : ""
                        }`}
                      />
                    </div>
                  </label>
