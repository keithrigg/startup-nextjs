...
const Footer = () => {
  ...
  // If not mounted yet, return null (or a minimal placeholder) to avoid mismatch
  if (!mounted) {
    return null;
  }
        ...
        <div className="container">
          ...
          <div className="py-8 flex flex-col gap-4 items-start sm:flex-row sm:justify-between sm:items-center">
            ...
            <div className="text-sm text-body-color dark:text-body-color-dark max-w-xxl leading-relaxed">
              <p>
                Inovize Solutions Ltd (trading as “Inovize”), registered in
                England &amp; Wales (No. 16214067).
              </p>
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor={brandColors.inovize_red} stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
